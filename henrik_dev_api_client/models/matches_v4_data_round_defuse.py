...
T = TypeVar("T", bound="MatchesV4DataRoundDefuse")


@_attrs_define
class MatchesV4DataRoundDefuse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matches_v4_data_round_defuse = cls(
            location=location,
            player=player,
            player_locations=player_locations,
            round_time_in_ms=round_time_in_ms,
        ...
        matches_v4_data_round_defuse.additional_properties = d
        return matches_v4_data_round_defuse
