...
T = TypeVar("T", bound="MatchesV2DataRoundPlayerStatsEconomyEquipmentAssets")


@_attrs_define
class MatchesV2DataRoundPlayerStatsEconomyEquipmentAssets:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matches_v2_data_round_player_stats_economy_equipment_assets = cls(
            display_icon=display_icon,
            killfeed_icon=killfeed_icon,
        )

        matches_v2_data_round_player_stats_economy_equipment_assets.additional_properties = d
        return matches_v2_data_round_player_stats_economy_equipment_assets
