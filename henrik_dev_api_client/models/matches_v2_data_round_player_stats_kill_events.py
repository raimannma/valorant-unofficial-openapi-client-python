...
T = TypeVar("T", bound="MatchesV2DataRoundPlayerStatsKillEvents")


@_attrs_define
class MatchesV2DataRoundPlayerStatsKillEvents:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matches_v2_data_round_player_stats_kill_events = cls(
            assistants=assistants,
            damage_weapon_assets=damage_weapon_assets,
            damage_weapon_id=damage_weapon_id,
            kill_time_in_match=kill_time_in_match,
        ...
        matches_v2_data_round_player_stats_kill_events.additional_properties = d
        return matches_v2_data_round_player_stats_kill_events
